...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { artist: @painting.artist, painting_url: @painting.painting_url, title: @painting.title } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { artist: @painting.artist, painting_url: @painting.painting_url, title: @painting.title } }
